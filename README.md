...
- 教师：魏宇虹
- 成绩构成：40%作业 60%实验
- 特别注意：作业和实验都是提交到一个网站上边，这个网站可能是部分同学大一C语言课程提交作业的网站。（反正老师都会给网址）
- 授课风格：无考勤 老师讲课挺认真的 PPT上边的内容基本够应付作业和实验 课程内容就是学习如何使用AI，简单学了Python的语法，但是作业和实验反正都是依靠AI解决的，毕竟是面向AI的课程。
- 学习建议：面向AI学习 反正课程的核心就是围绕AI 
- （其他想说的话）老师给分挺高的（身边统计学）作业实验都完成基本都90+。